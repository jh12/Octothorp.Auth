...
namespace Octothorp.Auth.Controllers;
...
public class AuthorizationController : Controller
{
    ...
    [HttpGet("userinfo"), Produces("text/plain")]
    public async Task<string> GetCurrentUser()
    {
        string identityJson = JsonSerializer.Serialize(HttpContext.User.Identity, new JsonSerializerOptions { WriteIndented = true });
        return identityJson;
    }

    [HttpGet("permissions"), Produces("application/json")]
